...
export const TableDatosPersonales = ({ estudents }) => {
                                        ...
                                        <Table size="small" aria-label="purchases">
                                            <TableBody>
                                                <TableRow>
                                                    ...
                                                    <TableCell  width='50%'>{estudents[0].nombre}</TableCell>
                                                </TableRow>
                                                <TableRow>
                                                    <TableCell  width='50%'>Matricula</TableCell>
                                                    <TableCell  width='50%'>{estudents[0].matricula}</TableCell>
                                                </TableRow>
                                                <TableRow>
                                                    <TableCell  width='50%'>Apellido Paterno</TableCell>
                                                    <TableCell  width='50%'>{estudents[0].apellidoPaterno}</TableCell>
                                                </TableRow>
                                                <TableRow>
                                                    <TableCell  width='50%'>Apellido Materno</TableCell>
                                                    <TableCell  width='50%'>{estudents[0].apellidoMaterno}</TableCell>
                                                </TableRow>
                                                <TableRow>
                                                    <TableCell  width='50%'>Numero de telefono</TableCell>
                                                    <TableCell  width='50%'>{estudents[0].datosPersonales.numeroTelefono}</TableCell>
                                                </TableRow>
                                                <TableRow>
